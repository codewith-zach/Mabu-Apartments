    ...
    <div className="flex flex-col lg:flex-row gap-8 lg:gap-20 items-start py-8 lg:py-16 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
      ...
      <div className="space-y-6 lg:space-y-8 w-full lg:max-w-xl xl:max-w-2xl px-4 sm:px-0 mt-8 lg:mt-0">
        ...
        <p className="text-neutral-600 leading-relaxed text-sm sm:text-base">
          At Mabu Apartments, we believe that every stay should feel like a special getaway. Our property was
          designed with you in mind—a perfect blend of comfort, style, and convenience that turns a simple trip
          into an unforgettable experience.
        </p>

        <p className="text-neutral-600 leading-relaxed text-sm sm:text-base">
          What sets us apart is our attention to detail. From the thoughtfully curated decor to the amenities
          that make life easier, every aspect of Mabu Apartments is designed to ensure your comfort. We&apos;re
          passionate about hospitality and dedicated to making your visit seamless, enjoyable, and memorable.
        </p>

        <p className="text-neutral-600 leading-relaxed text-sm sm:text-base">
          Explore the charm of Abuja, relax in our cozy space, and let us take care of the rest. At Mabu Apartments,
          you&apos;re not just a guest—you&apos;re part of our story.
        </p>
