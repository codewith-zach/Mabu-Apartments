...
export function RoomDescription({ description, capacity }: RoomDescriptionProps) {
  return (
      ...
      <div className="max-w-6xl mx-auto px-4 md:px-8 py-16">
        <div className="grid lg:grid-cols-2 gap-16">
          <div className="space-y-6 lg:sticky lg:top-20 pt-4">
            ...
            <h2 className="text-3xl font-bold mb-8">Luxury Meets Comfort in Every Corner.</h2>
            <div className="space-y-4 text-neutral-600">
              <p className="text-base mb-8 leading-relaxed text-gray-600">{description}</p>
              <p className="text-base mb-8 leading-relaxed text-gray-600">
                This room can accommodate up to {capacity} {capacity === 1 ? "person" : "people"}.
              </p>
              <p className="text-base mb-8 leading-relaxed text-gray-600">
                Whether you&apos;re visiting for business or leisure, our rooms provide the ideal balance of luxury and
                convenience, ensuring a restful and memorable stay.{" "}
              </p>
            </div>
          </div>
